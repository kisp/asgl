Feature: stable
  ...
  As a user of asgl
  I want to be able to compute extensions in stable semantics

  Scenario: enumerate all ex0
  ...
  Scenario: some extensions ex0
     Given a file named "g.apx" with:
     """
     arg(arg1).
     att(arg1,arg1).
     """
     When I run `asgl -p SE-ST -fo apx -f "g.apx"`
     Then the exit status should be 0
  ...
  Scenario: skeptical acceptance ex1
     ...
     arg(arg1).
     """
     When I run `asgl -p DS-ST -fo apx -f "g.apx" -a arg1`
     Then the exit status should be 0
  ...
  Scenario: skeptical acceptance ex4
     ...
     att(9,8).
     """
     When I run `asgl -p DS-ST -fo apx -f "g.apx" -a 3`
     Then the exit status should be 0
     And the output should be eql to "YES"
  ...
  Scenario: skeptical acceptance ex5
     ...
     att(9,8).
     """
     When I run `asgl -p DS-ST -fo apx -f "g.apx" -a 9`
     Then the exit status should be 0
     And the output should be eql to "NO"
  ...
  Scenario: credulous acceptance ex1
     ...
     arg(arg1).
     """
     When I run `asgl -p DC-ST -fo apx -f "g.apx" -a arg1`
     Then the exit status should be 0
     And the output should be eql to "YES"
  ...
  Scenario: credulous acceptance ex4
     ...
     att(9,8).
     """
     When I run `asgl -p DC-ST -fo apx -f "g.apx" -a 3`
     Then the exit status should be 0
     And the output should be eql to "YES"
  ...
  Scenario: credulous acceptance ex5
     ...
     att(9,8).
     """
     When I run `asgl -p DC-ST -fo apx -f "g.apx" -a 9`
     Then the exit status should be 0
     And the output should be eql to "YES"
