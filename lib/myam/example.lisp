...
;;;; * myam Example (poor man's tutorial)

(asdf:oos 'asdf:load-op :myam)

(defpackage :myam.example
  (:use :common-lisp
        :myam))

(in-package :myam.example)
...
(defsuite example-suite :description "The example test suite.")
...
(deftest add-2 "Test the ADD-2 function"
         (is (= 2 (add-2 0)))
         (is (= 0 (add-2 -2))))
