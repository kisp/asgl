...
/*      Source: /home/packer/ws/github/kisp/asgl/lib/alexandria/definitions.lisp */
...
L7:;
   {
    ...
    CLV0 = env1 = CONS(ECL_NIL,env1);
    {
     ...
     {
      cl_object v5;
      v5 = ecl_make_cclosure_va((cl_objectfn)LC1__lambda8,env2,Cblock,0);
      T0 = v5;
     }
     {
      cl_object v5;
      v5 = ecl_make_cfun((cl_objectfn_fixed)LC2__lambda9,ECL_NIL,Cblock,1);
      T1 = v5;
     }
     T2 = ecl_function_dispatch(cl_env_copy,VV[12])(6, ECL_SYM("NAME",1306), ECL_SYM("IGNORE",430), ECL_SYM("FUNCTION",1270), T0, VV[3], T1) /*  MAKE-RESTART */;
     {
      cl_object v5;
      v5 = ecl_make_cclosure_va((cl_objectfn)LC3__lambda10,env2,Cblock,0);
      T3 = v5;
     }
     {
      cl_object v5;
      v5 = ecl_make_cfun((cl_objectfn_fixed)LC4__lambda11,ECL_NIL,Cblock,1);
      T4 = v5;
     }
     T5 = ecl_function_dispatch(cl_env_copy,VV[12])(6, ECL_SYM("NAME",1306), ECL_SYM("CONTINUE",252), ECL_SYM("FUNCTION",1270), T3, VV[3], T4) /*  MAKE-RESTART */;
     T6 = cl_list(2, T2, T5);
     ...
     ecl_bds_bind(cl_env_copy,ECL_SYM("*RESTART-CLUSTERS*",5),T7); /*  *RESTART-CLUSTERS* */
     {
      ...
      v5 = ecl_function_dispatch(cl_env_copy,VV[13])(4, VV[6], T0, ECL_SYM("SIMPLE-ERROR",772), ECL_SYM("ERROR",339)) /*  COERCE-TO-CONDITION */;
...
L9:;
     {
      ...
      if (Null(v5)) { goto L19; }
      ecl_function_dispatch(cl_env_copy,VV[14])(1, ECL_NIL) /*  DM-TOO-MANY-ARGUMENTS */;
L19:;
      value0 = v4;
      cl_env_copy->nvalues = 1;
      ecl_frs_pop(cl_env_copy);
...
/*      closure LAMBDA8                                               */
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC1__lambda8(cl_narg narg, ...)
{
 cl_object CLV0, CLV1;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC2__lambda9(cl_object v1stream)
{
...
/*      closure LAMBDA10                                              */
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC3__lambda10(cl_narg narg, ...)
{
 cl_object CLV0, CLV1;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object env0 = cl_env_copy->function->cclosure.env;
...
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC4__lambda11(cl_object v1stream)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
...
L9:;
   ...
   v6 = ecl_function_dispatch(cl_env_copy,VV[18])(2, v3, ECL_SYM("TEST",1350)) /*  SEARCH-KEYWORD */;
...
L16:;
   v7test = v6;
L15:;
   v8 = ecl_function_dispatch(cl_env_copy,VV[18])(2, v3, ECL_SYM("DOCUMENTATION",1250)) /*  SEARCH-KEYWORD */;
   if (!((v8)==(ECL_SYM("MISSING-KEYWORD",2037)))) { goto L20; }
   v9documentation = ECL_NIL;
   goto L19;
L20:;
   v9documentation = v8;
L19:;
   ecl_function_dispatch(cl_env_copy,VV[19])(2, v3, VV[10]) /*  CHECK-KEYWORD */;
...
L24:;
   T2 = ECL_NIL;
L23:;
   value0 = cl_listX(4, ECL_SYM("DEFCONSTANT",279), v4name, T1, T2);
   return value0;
  }
 }
}
...
extern "C"
#endif
ECL_DLLEXPORT void _eclEwTbx6vhJ21IM_CgEycC71(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 flag->cblock.source = ecl_make_constant_base_string("/home/packer/ws/github/kisp/asgl/lib/alexandria/definitions.lisp",-1);
 return;}
 #ifdef ECL_DYNAMIC_VV
 VV = Cblock->cblock.data;
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclEwTbx6vhJ21IM_CgEycC71@";
 ...
 ECL_DEFINE_SETF_FUNCTIONS
  ...
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[8], ECL_SYM("LOCATION",1862), VVtemp[4], VVtemp[5]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[8], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[6]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[15]);                       /*  DEFINE-CONSTANT */
  ecl_function_dispatch(cl_env_copy,VV[16])(3, VV[8], ECL_SYM("FUNCTION",398), VVtemp[7]) /*  SET-DOCUMENTATION */;
}
