...
/*      Source: /home/packer/ws/github/kisp/asgl/lib/alexandria/macros.lisp */
...
TTL:
  {
   ...
   ecl_function_dispatch(cl_env_copy,VV[45])(1, v1) /*  DM-TOO-FEW-ARGUMENTS */;
L3:;
   {
    cl_object v5;
    v5 = ecl_car(v3);
   ...
   }
   {
    ...
    {
     cl_object v6;
     v6 = ecl_make_cfun((cl_objectfn_fixed)LC1__lambda16,ECL_NIL,Cblock,1);
     v5 = v6;
    }
    {
     cl_object v6;
...
L8:;
   value0 = cl_listX(3, ECL_SYM("LET",479), T0, v3);
   return value0;
  }
 }
}
...
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC1__lambda16(cl_object v1name)
{
 cl_object T0, T1, T2;
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
L1:;
   ...
   T0 = cl_list(2, ECL_SYM("GENSYM",402), v4);
...
L3:;
   ...
   }
   {
    ...
    cl_object v6;
    {
     ...
     v5 = ecl_function_dispatch(cl_env_copy,VV[48])(2, ecl_make_fixnum(v7), VV[5]) /*  MAKE-GENSYM-LIST */;
    }
    {
     cl_object v7;
     {
      cl_object v8;
      v8 = ecl_make_cfun((cl_objectfn_fixed)LC4__lambda53,ECL_NIL,Cblock,1);
      v7 = v8;
     }
     {
      cl_object v8;
...
L9:;
    {
     ...
     {
      cl_object v8;
      v8 = ecl_make_cfun((cl_objectfn_fixed)LC5__lambda68,ECL_NIL,Cblock,2);
      v7 = v8;
     }
     {
      cl_object v8;
...
L35:;
    {
     ...
     {
      cl_object v8;
      v8 = ecl_make_cfun((cl_objectfn_fixed)LC6__lambda80,ECL_NIL,Cblock,2);
      v7 = v8;
     }
     {
      cl_object v8;
...
L73:;
    T2 = CONS(ECL_SYM("LIST",483),T1);
    {
     ...
     {
      cl_object v8;
      v8 = ecl_make_cfun((cl_objectfn_fixed)LC7__lambda92,ECL_NIL,Cblock,2);
      v7 = v8;
     }
     {
      cl_object v8;
...
L111:;
    T4 = cl_listX(3, ECL_SYM("LET",479), T3, v3);
    T5 = cl_list(4, ECL_SYM("LIST",483), VV[7], T2, T4);
...
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC4__lambda53(cl_object v1spec)
{
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
...
TTL:
  if (!(ECL_LISTP(v1spec))) { goto L1; }
  {
   ...
   ecl_function_dispatch(cl_env_copy,VV[45])(1, v1spec) /*  DM-TOO-FEW-ARGUMENTS */;
L5:;
   {
    cl_object v5;
    v5 = ecl_car(v2);
...
L11:;
   ...
   if (Null(v2)) { goto L16; }
   ecl_function_dispatch(cl_env_copy,VV[49])(1, v1spec) /*  DM-TOO-MANY-ARGUMENTS */;
L16:;
...
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC5__lambda68(cl_object v1g, cl_object v2n)
{
 cl_object T0, T1, T2;
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
TTL:
  T0 = ecl_car(v2n);
  T1 = cl_string(T0);
  T2 = cl_list(2, ECL_SYM("GENSYM",402), T1);
...
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC6__lambda80(cl_object v1g, cl_object v2n)
{
 cl_object T0;
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
TTL:
  T0 = ecl_cdr(v2n);
  value0 = cl_list(3, ECL_SYM("LIST",483), v1g, T0);
  return value0;
 }
}
/*      local function LAMBDA92                                       */
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC7__lambda92(cl_object v1n, cl_object v2g)
{
 cl_object T0;
 cl_object env0 = ECL_NIL;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
L13:;
   {
    ...
    v7 = v1body;
    {
     ...
     v8 = v7;
     {
      ...
      v9 = ECL_LISTP(v8);
      if (ecl_unlikely(!(v9)))
         FEwrong_type_argument(VV[10],v8);
      value0 = ECL_NIL;
      cl_env_copy->nvalues = 0;
     }
    }
...
L8:;
   ...
   if (!((T0)==(ECL_SYM("DECLARE",276)))) { goto L30; }
   {
    cl_object v7;
    v7 = v1body;
    {
...
L17:;
    {
     ...
     v16elt = ecl_car(v15);
     {
      cl_object v17;
      v17 = v16elt;
      if (!((v17)==(ECL_SYM("&OPTIONAL",13)))) { goto L24; }
      if (!((v6state)==(ECL_SYM("REQUIRED",1010)))) { goto L26; }
      v6state = v16elt;
      goto L22;
L26:;
      ...
      goto L22;
L24:;
      if (!((v17)==(ECL_SYM("&REST",14)))) { goto L29; }
      if (!((v6state)==(ECL_SYM("REQUIRED",1010)))) { goto L36; }
      goto L33;
      goto L34;
L36:;
      goto L34;
L34:;
      if (!((v6state)==(ECL_SYM("&OPTIONAL",13)))) { goto L31; }
      goto L32;
L33:;
L32:;
      v6state = v16elt;
...
L31:;
      ...
      goto L22;
L29:;
      if (!((v17)==(ECL_SYM("&KEY",12)))) { goto L40; }
      if (!((v6state)==(ECL_SYM("REQUIRED",1010)))) { goto L48; }
      goto L45;
      goto L46;
L48:;
      goto L46;
L46:;
      if (!((v6state)==(ECL_SYM("&OPTIONAL",13)))) { goto L52; }
      goto L45;
      goto L50;
L52:;
      goto L50;
L50:;
      if (!((v6state)==(VV[18]))) { goto L43; }
      goto L44;
L45:;
L44:;
      v6state = v16elt;
...
L42:;
      ...
      goto L22;
L40:;
      if (!((v17)==(ECL_SYM("&ALLOW-OTHER-KEYS",8)))) { goto L57; }
      if (!((v6state)==(ECL_SYM("&KEY",12)))) { goto L59; }
...
L59:;
      ...
      goto L22;
L57:;
      if (!((v17)==(ECL_SYM("&AUX",9)))) { goto L64; }
      if (!((v6state)==(ECL_SYM("&REST",14)))) { goto L66; }
      LC10fail(lex0, v16elt);
      goto L22;
L66:;
      if (Null(v8auxp)) { goto L68; }
      ecl_function_dispatch(cl_env_copy,VV[59])(3, VV[20], v16elt, lex0[0]) /*  SIMPLE-PROGRAM-ERROR */;
      goto L22;
L68:;
      v8auxp = ECL_T;
      v6state = v16elt;
      goto L22;
L64:;
      if (!((v16elt)==(ECL_SYM("&WHOLE",15)))) { goto L78; }
      goto L75;
      goto L76;
L78:;
      goto L76;
L76:;
      if (!((v16elt)==(ECL_SYM("&ENVIRONMENT",11)))) { goto L82; }
      goto L75;
      goto L80;
L82:;
      goto L80;
L80:;
      if (!((v16elt)==(ECL_SYM("&BODY",10)))) { goto L73; }
      goto L74;
L75:;
L74:;
      ecl_function_dispatch(cl_env_copy,VV[59])(3, VV[24], v16elt, lex0[0]) /*  SIMPLE-PROGRAM-ERROR */;
L73:;
      {
       cl_object v18;
       v18 = v6state;
       if (!((v18)==(ECL_SYM("REQUIRED",1010)))) { goto L86; }
       LC11check_variable(2, lex0, v16elt, VV[25]);
       v9required = CONS(v16elt,v9required);
       goto L22;
L86:;
       if (!((v18)==(ECL_SYM("&OPTIONAL",13)))) { goto L90; }
       if (!(ECL_CONSP(v16elt))) { goto L93; }
       {
        ...
        ecl_function_dispatch(cl_env_copy,VV[45])(1, v19) /*  DM-TOO-FEW-ARGUMENTS */;
L98:;
        {
         cl_object v22;
         v22 = ecl_car(v20);
        ...
        LC11check_variable(2, lex0, v21name, VV[26]);
        if (Null(ecl_cdr(v20))) { goto L104; }
        LC12check_spec(lex0, v20, VV[27]);
        goto L92;
L104:;
        if (Null(v3normalize_optional)) { goto L92; }
        v16elt = ecl_append(v16elt,VV[28]);
        goto L92;
       }
L93:;
       LC11check_variable(2, lex0, v16elt, VV[26]);
       if (Null(v3normalize_optional)) { goto L92; }
       v16elt = CONS(v16elt,VV[29]);
L92:;
       T0 = ecl_function_dispatch(cl_env_copy,VV[60])(1, v16elt) /*  ENSURE-LIST */;
       v10optional = CONS(T0,v10optional);
       goto L22;
L90:;
       if (!((v18)==(ECL_SYM("&REST",14)))) { goto L112; }
       LC11check_variable(2, lex0, v16elt, VV[30]);
       v11rest = v16elt;
       v6state = VV[18];
       goto L22;
L112:;
       if (!((v18)==(ECL_SYM("&KEY",12)))) { goto L118; }
...
L126:;
        ...
        if (!(ECL_CONSP(v21var_or_kv))) { goto L133; }
        {
         ...
         ecl_function_dispatch(cl_env_copy,VV[45])(1, v21var_or_kv) /*  DM-TOO-FEW-ARGUMENTS */;
L137:;
         {
          cl_object v26;
          v26 = ecl_car(v23);
...
L143:;
         ...
         ecl_function_dispatch(cl_env_copy,VV[49])(1, v21var_or_kv) /*  DM-TOO-MANY-ARGUMENTS */;
L148:;
         if (ECL_SYMBOLP(v24keyword)) { goto L150; }
         ecl_function_dispatch(cl_env_copy,VV[59])(3, VV[31], v24keyword, lex0[0]) /*  SIMPLE-PROGRAM-ERROR */;
L150:;
         LC11check_variable(2, lex0, v25var, VV[32]);
         goto L132;
        }
L133:;
        LC11check_variable(2, lex0, v21var_or_kv, VV[32]);
        if (Null(v4normalize_keyword)) { goto L132; }
        T0 = ecl_function_dispatch(cl_env_copy,VV[61])(1, v21var_or_kv) /*  MAKE-KEYWORD */;
        v21var_or_kv = cl_list(2, T0, v21var_or_kv);
L132:;
        if (Null(ecl_cdr(v22tail))) { goto L156; }
        LC12check_spec(lex0, v22tail, VV[33]);
        goto L155;
L156:;
        if (Null(v4normalize_keyword)) { goto L155; }
        v22tail = ecl_append(v22tail,VV[28]);
L155:;
        v16elt = CONS(v21var_or_kv,v22tail);
        goto L120;
       }
L121:;
       LC11check_variable(2, lex0, v16elt, VV[32]);
       if (Null(v4normalize_keyword)) { goto L163; }
       T0 = ecl_function_dispatch(cl_env_copy,VV[61])(1, v16elt) /*  MAKE-KEYWORD */;
...
L120:;
       ...
       goto L22;
L118:;
       if (!((v18)==(ECL_SYM("&AUX",9)))) { goto L166; }
       if (!(ECL_CONSP(v16elt))) { goto L169; }
       {
        ...
        ecl_function_dispatch(cl_env_copy,VV[45])(1, v16elt) /*  DM-TOO-FEW-ARGUMENTS */;
L173:;
        {
         cl_object v22;
         v22 = ecl_car(v19);
...
L178:;
        ...
        ecl_function_dispatch(cl_env_copy,VV[49])(1, v16elt) /*  DM-TOO-MANY-ARGUMENTS */;
L184:;
        LC11check_variable(2, lex0, v20var, VV[34]);
        goto L168;
       }
L169:;
       LC11check_variable(2, lex0, v16elt, VV[34]);
...
L168:;
       ...
       goto L22;
L166:;
       ecl_function_dispatch(cl_env_copy,VV[59])(2, VV[35], lex0[0]) /*  SIMPLE-PROGRAM-ERROR */;
      }
     }
L22:;
    }
...
L5:;
  goto L3;
L3:;
  value0 = ecl_function_dispatch(cl_env_copy,VV[59])(4, VV[13], v2what, v1elt, lex0[0]) /*  SIMPLE-PROGRAM-ERROR */;
  return value0;
L2:;
  value0 = ECL_NIL;
  cl_env_copy->nvalues = 1;
...
static cl_object LC10fail(volatile cl_object *lex0, cl_object v1elt)
{
 ...
 {
TTL:
  value0 = ecl_function_dispatch(cl_env_copy,VV[59])(3, VV[12], v1elt, lex0[0]) /*  SIMPLE-PROGRAM-ERROR */;
  return value0;
 }
}
...
TTL:
  {
   ...
   T1 = ecl_list1(T0);
   {
    ...
    T3 = cl_list(3, ECL_SYM("TYPEP",877), ECL_CONS_CAR(CLV0), VV[38]);
    T4 = cl_list(2, ECL_SYM("CAR",182), ECL_CONS_CAR(CLV0));
    {
     cl_object v5;
     {
      cl_object v6;
      v6 = ecl_make_cclosure_va((cl_objectfn)LC14__lambda196,env1,Cblock,1);
      v5 = v6;
     }
     {
      cl_object v6;
...
L3:;
    ...
    T7 = cl_list(2, ECL_SYM("QUOTE",681), v3case);
    T8 = cl_list(4, ECL_SYM("ERROR",339), VV[39], T7, ECL_CONS_CAR(CLV0));
    T2 = cl_list(4, ECL_SYM("IF",948), T3, T6, T8);
   }
...
/*      closure LAMBDA196                                             */
/*      optimize speed 3, debug 0, space 0, safety 2                  */
static cl_object LC14__lambda196(cl_narg narg, cl_object v1clause, ...)
{
 cl_object T0, T1;
 cl_object CLV0;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
TTL:
  {
   ...
   ecl_function_dispatch(cl_env_copy,VV[45])(1, v1clause) /*  DM-TOO-FEW-ARGUMENTS */;
L3:;
   {
    cl_object v6;
    v6 = ecl_car(v2);
...
L10:;
   ...
   T0 = cl_list(2, ECL_SYM("CDR",200), ECL_CONS_CAR(CLV0));
   T1 = cl_listX(4, ECL_SYM("DESTRUCTURING-BIND",302), v4, T0, v2);
...
L3:;
   ...
   value0 = L15expand_destructuring_case(v4keyform, v3, ECL_SYM("CASE",183));
   return value0;
  }
 }
}
...
L3:;
   ...
   value0 = L15expand_destructuring_case(v4keyform, v3, ECL_SYM("CCASE",185));
   return value0;
  }
 }
}
...
L3:;
   ...
   value0 = L15expand_destructuring_case(v4keyform, v3, ECL_SYM("ECASE",323));
   return value0;
  }
 }
}
...
extern "C"
#endif
ECL_DLLEXPORT void _ecl4KRmknIfrdJJM_OjFycC71(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 flag->cblock.source = ecl_make_constant_base_string("/home/packer/ws/github/kisp/asgl/lib/alexandria/macros.lisp",-1);
 return;}
 #ifdef ECL_DYNAMIC_VV
 VV = Cblock->cblock.data;
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_ecl4KRmknIfrdJJM_OjFycC71@";
 ...
 ECL_DEFINE_SETF_FUNCTIONS
  ...
  ecl_cmp_defmacro(VV[43]);                       /*  WITH-GENSYMS    */
  ecl_function_dispatch(cl_env_copy,VV[44])(3, VV[0], ECL_SYM("FUNCTION",398), VVtemp[4]) /*  SET-DOCUMENTATION */;
  ...
  ecl_cmp_defmacro(VV[46]);                       /*  WITH-UNIQUE-NAMES */
  ecl_function_dispatch(cl_env_copy,VV[44])(3, VV[3], ECL_SYM("FUNCTION",398), VVtemp[7]) /*  SET-DOCUMENTATION */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[4], ECL_SYM("LOCATION",1862), VVtemp[8], VVtemp[9]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[4], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[10]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[47]);                       /*  ONCE-ONLY       */
  ecl_function_dispatch(cl_env_copy,VV[44])(3, VV[4], ECL_SYM("FUNCTION",398), VVtemp[11]) /*  SET-DOCUMENTATION */;
  ...
  ecl_cmp_defun(VV[50]);                          /*  PARSE-BODY      */
  ecl_function_dispatch(cl_env_copy,VV[44])(3, VV[8], ECL_SYM("FUNCTION",398), VVtemp[15]) /*  SET-DOCUMENTATION */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[11], ECL_SYM("LOCATION",1862), VVtemp[16], VVtemp[17]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[11], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[18]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[53]);                          /*  PARSE-ORDINARY-LAMBDA-LIST */
  ecl_function_dispatch(cl_env_copy,VV[44])(3, VV[11], ECL_SYM("FUNCTION",398), VVtemp[19]) /*  SET-DOCUMENTATION */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[36], ECL_SYM("LOCATION",1862), VVtemp[20], VVtemp[21]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[36], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[22]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[62]);                          /*  EXPAND-DESTRUCTURING-CASE */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[40], ECL_SYM("LOCATION",1862), VVtemp[23], VVtemp[24]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[40], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[25]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[63]);                       /*  DESTRUCTURING-CASE */
  ecl_function_dispatch(cl_env_copy,VV[44])(3, VV[40], ECL_SYM("FUNCTION",398), VVtemp[26]) /*  SET-DOCUMENTATION */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[41], ECL_SYM("LOCATION",1862), VVtemp[27], VVtemp[28]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[41], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[25]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[64]);                       /*  DESTRUCTURING-CCASE */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[42], ECL_SYM("LOCATION",1862), VVtemp[29], VVtemp[30]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[42], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[25]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[65]);                       /*  DESTRUCTURING-ECASE */
  {
   cl_object v1;
   v1 = VVtemp[31];
   goto L51;
L50:;
   {
    ...
    {
     cl_object v3;
     v3 = (cl_env_copy->function=(ECL_SYM("DOCUMENTATION",314)->symbol.gfdef))->cfun.entry(2, VV[40], ECL_SYM("FUNCTION",398)) /*  DOCUMENTATION */;
     (cl_env_copy->function=ECL_CONS_CAR(VV[66]))->cfun.entry(3, v3, v2name, ECL_SYM("FUNCTION",398)) /*  (SETF DOCUMENTATION) */;
    }
   }
   v1 = ecl_cdr(v1);
L51:;
