...
/*      Source: /home/packer/ws/github/kisp/asgl/common/early/utils.lisp */
...
TTL:
  ...
  {
   bool v2;
   v2 = ecl_eql(v1value,ECL_SYM("UNSPECIFIC",1354));
...
TTL:
  {
   ...
   ecl_function_dispatch(cl_env_copy,VV[40])(1, v1) /*  DM-TOO-FEW-ARGUMENTS */;
L3:;
   {
    cl_object v7;
    v7 = ECL_CONS_CAR(v3);
...
L14:;
   if (Null(v3)) { goto L20; }
   ecl_function_dispatch(cl_env_copy,VV[41])(1, v1) /*  DM-TOO-MANY-ARGUMENTS */;
L20:;
   T0 = cl_list(2, VV[7], v4test);
   T1 = ecl_list1(T0);
   T2 = cl_list(4, ECL_SYM("IF",948), VV[7], v5then, v6else);
...
L3:;
   ...
   }
   {
    ...
    v5 = v4level;
    {
     ...
     v6 = v5;
     if (ecl_greatereq(v6,ecl_make_fixnum(0))) { goto L10; }
     goto L11;
L14:;
     goto L11;
    }
...
L6:;
   if (!(ecl_lower(v3x,ecl_make_fixnum(1)))) { goto L8; }
   goto L7;
L8:;
   T0 = si_ihs_fun(v3x);
   ...
   cl_format(2, v1eout, VV[19]);
   {
    cl_object v4env;
    T0 = si_ihs_env(v3x);
    v4env = ecl_function_dispatch(cl_env_copy,VV[45])(1, T0) /*  DECODE-IHS-ENV */;
    {
     cl_object v5;
     v5 = v4env;
     goto L18;
...
TTL:
  {
   ...
   T0 = (cl_env_copy->function=(ECL_SYM("COMPILE-FILE-PATHNAME",237)->symbol.gfdef))->cfun.entry(1, v1source_file) /*  COMPILE-FILE-PATHNAME */;
...
TTL:
  ...
  value0 = ecl_make_bool(ecl_greater(T0,T1));
  cl_env_copy->nvalues = 1;
  return value0;
 }
}
...
TTL:
  ...
  (cl_env_copy->function=(ECL_SYM("COMPILE-FILE",236)->symbol.gfdef))->cfun.entry(1, v1filename) /*  COMPILE-FILE */;
L1:;
  if (Null(v2loadp)) { goto L3; }
  T0 = (cl_env_copy->function=(ECL_SYM("COMPILE-FILE-PATHNAME",237)->symbol.gfdef))->cfun.entry(1, v1filename) /*  COMPILE-FILE-PATHNAME */;
  cl_load(1, T0);
L3:;
  value0 = (cl_env_copy->function=(ECL_SYM("COMPILE-FILE-PATHNAME",237)->symbol.gfdef))->cfun.entry(1, v1filename) /*  COMPILE-FILE-PATHNAME */;
  return value0;
 }
}
...
TTL:
  {
   ...
   T2 = cl_sort(2, T0, T1);
   v3sorted_vect = ecl_function_dispatch(cl_env_copy,VV[51])(4, T2, ECL_T, ECL_SYM("*",20), ECL_T) /*  COERCE-TO-VECTOR */;
...
TTL:
  ...
  T10 = (ECL_SYM("MAX",553)->symbol.gfdef);
...
L1:;
  ...
  T3 = cl_format(3, ECL_NIL, VV[30], T2);
  T4 = (ECL_SYM("MAX",553)->symbol.gfdef);
...
extern "C"
#endif
ECL_DLLEXPORT void _eclb840kDV4LgEAM_JODycC71(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 flag->cblock.source = ecl_make_constant_base_string("/home/packer/ws/github/kisp/asgl/common/early/utils.lisp",-1);
 return;}
 #ifdef ECL_DYNAMIC_VV
 VV = Cblock->cblock.data;
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclb840kDV4LgEAM_JODycC71@";
 ...
 ECL_DEFINE_SETF_FUNCTIONS
  ...
  ecl_function_dispatch(cl_env_copy,VV[36])(3, VV[0], ECL_SYM("FUNCTION",398), VVtemp[5]) /*  SET-DOCUMENTATION */;
  ...
  ecl_cmp_defun(VV[37]);                          /*  DIRECTORY-PATHNAME-P */
  ecl_function_dispatch(cl_env_copy,VV[36])(3, VV[1], ECL_SYM("FUNCTION",398), VVtemp[9]) /*  SET-DOCUMENTATION */;
  ...
  ecl_cmp_defmacro(VV[39]);                       /*  AIF             */
  si_Xmake_special(VV[8]);
  if (ECL_SYM_VAL(cl_env_copy,VV[8])!=OBJNULL) { goto L27; }
  cl_set(VV[8],ECL_NIL);
L27:;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[8], ECL_SYM("LOCATION",1862), VVtemp[15], VVtemp[16]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[9], ECL_SYM("LOCATION",1862), VVtemp[17], VVtemp[18]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[9], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[19]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[42]);                       /*  WITH-TIMING     */
  si_Xmake_special(VV[10]);
  if (ECL_SYM_VAL(cl_env_copy,VV[10])!=OBJNULL) { goto L40; }
...
L40:;
  ...
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[12], ECL_SYM("LOCATION",1862), VVtemp[24], VVtemp[25]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[12], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[26]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[43]);                       /*  LOG*            */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[15], ECL_SYM("LOCATION",1862), VVtemp[27], VVtemp[28]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[15], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[29]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[44]);                          /*  PRINT-ERROR-LOG */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[22], ECL_SYM("LOCATION",1862), VVtemp[30], VVtemp[31]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[22], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[32]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[46]);                          /*  REQUIRES-COMPILE-P */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[23], ECL_SYM("LOCATION",1862), VVtemp[33], VVtemp[34]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[23], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[35]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[47]);                          /*  COMPILE-FILE-IF-NEEDED */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[24], ECL_SYM("LOCATION",1862), VVtemp[36], VVtemp[37]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[24], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[38]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[48]);                          /*  MEAN            */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[25], ECL_SYM("LOCATION",1862), VVtemp[39], VVtemp[40]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[25], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[38]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[49]);                          /*  MEDIAN          */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[26], ECL_SYM("LOCATION",1862), VVtemp[41], VVtemp[42]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[26], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[43]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[50]);                          /*  PERCENTILE      */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[27], ECL_SYM("LOCATION",1862), VVtemp[44], VVtemp[45]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1856))(4, VV[27], ECL_SYM("LAMBDA-LIST",1000), ECL_NIL, VVtemp[38]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[52]);                          /*  SUMMARY         */
}
