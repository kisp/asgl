...
/*      Source: common/early/graph.lisp                               */
...
L27:;
   ...
   value0 = cl_listX(3, ECL_SYM("DOLIST",313), T0, T1);
   return value0;
  }
 }
}
...
L14:;
   {
    ...
    value0 = (cl_env_copy->function=(ECL_SYM("GET-SETF-EXPANSION",410)->symbol.gfdef))->cfun.entry(2, v5place, v2env) /*  GET-SETF-EXPANSION */;
    v7 = value0;
    ...
    v11 = cl_env_copy->values[4];
    {
     ...
     {
      cl_object v13;
      v13 = (ECL_SYM("LIST",481)->symbol.gfdef);
      {
       cl_object v14;
       cl_object v15;
       v14 = ECL_NIL;
...
L18:;
     ...
     T7 = ecl_append(T1,T6);
     T8 = CONS(T0,T7);
     value0 = cl_list(3, ECL_SYM("LET*",478), T8, v10);
     return value0;
    }
   }
  }
...
TTL:
  ...
  value0 = cl_reduce(4, T0, v1graph, ECL_SYM("KEY",1267), T1);
  return value0;
 }
}
...
static cl_object L9indegrees(cl_object v1graph)
{
 ...
 {
TTL:
  T0 = (ECL_SYM("LENGTH",476)->symbol.gfdef);
  value0 = cl_map(3, ECL_SYM("VECTOR",898), T0, v1graph);
  return value0;
 }
}
...
TTL:
  {
   cl_object env1 = env0;
   T0 = L7order(v1graph);
   T1 = si_make_pure_array(ECL_T, T0, ECL_NIL, ECL_NIL, ECL_NIL, ecl_make_fixnum(0));
   T2 = si_fill_array_with_elt(T1, ecl_make_fixnum(0), ecl_make_fixnum(0), ECL_NIL);
   env1 = ECL_NIL;
   CLV0 = env1 = CONS(T2,env1);                   /*  VECTOR          */
   {
    cl_object v2;
    v2 = ecl_make_cclosure_va((cl_objectfn)LC13__g84,env1,Cblock);
    T0 = v2;
   }
...
/*      closure G84                                                   */
/*      optimize speed 3, debug 0, space 0, safety 1                  */
static cl_object LC13__g84(cl_narg narg, cl_object v1from, cl_object v2to, ...)
{
 cl_object T0, T1;
 cl_object CLV0;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
L11:;
     if (!(ecl_number_compare(v5j,ecl_make_fixnum(v2order))<0)) { goto L35; }
     goto L10;
L35:;
    }
    v4i = ecl_one_plus(v4i);
L6:;
    if (!(ecl_number_compare(v4i,ecl_make_fixnum(v2order))<0)) { goto L39; }
    goto L5;
L39:;
   }
   value0 = v3graph;
...
L3:;
   {
    cl_object v5;
    v5 = ecl_aref_unsafe(v2graph,v4i);
    goto L10;
L9:;
    {
     cl_object v6j;
...
static cl_object L21map_parents(cl_object v1fn, cl_object v2graph)
{
 ...
 cl_object value0;
 {
  ...
  {
   cl_object v3;
   v3 = ecl_make_cclosure_va((cl_objectfn)LC20__g158,env0,Cblock);
   T0 = v3;
  }
...
/*      closure G158                                                  */
/*      optimize speed 3, debug 0, space 0, safety 1                  */
static cl_object LC20__g158(cl_narg narg, cl_object v1node, ...)
{
 cl_object T0, T1;
 cl_object CLV0, CLV1;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
static cl_object L24map_parents_grandparents(cl_object v1fn, cl_object v2graph)
{
 ...
 cl_object value0;
 {
  ...
  {
   cl_object v3;
   v3 = ecl_make_cclosure_va((cl_objectfn)LC23__g161,env0,Cblock);
   T0 = v3;
  }
...
/*      closure G161                                                  */
/*      optimize speed 3, debug 0, space 0, safety 1                  */
static cl_object LC23__g161(cl_narg narg, cl_object v1node, cl_object v2parents, ...)
{
 cl_object T0, T1, T2;
 cl_object CLV0, CLV1;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
TTL:
  {
   cl_object v3;
   v3 = (ECL_SYM("CONS",251)->symbol.gfdef);
   {
    cl_object v4;
    cl_object v5;
    v4 = ECL_NIL;
    ...
    }
    {
     ...
     cl_object v8;
     {
      ...
      {
       cl_object v10;
       v10 = ecl_make_cclosure_va((cl_objectfn)LC22__g178,env0,Cblock);
       v9 = v10;
      }
      {
       cl_object v10;
...
/*      closure G178                                                  */
/*      optimize speed 3, debug 0, space 0, safety 1                  */
static cl_object LC22__g178(cl_narg narg, cl_object v1parent, ...)
{
 cl_object T0;
 cl_object CLV0, CLV1;
 const cl_env_ptr cl_env_copy = ecl_process_env();
...
extern "C"
#endif
ECL_DLLEXPORT void _eclLTqb7ItxYx5DM_hNf2dC71(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 flag->cblock.source = make_constant_base_string("/home/packer/ws/github/kisp/asgl/common/early/graph.lisp");
 return;}
 ...
 ECL_DEFINE_SETF_FUNCTIONS
  ...
  si_do_deftype(3, VV[0], VVtemp[2], ECL_SYM("SIMPLE-ARRAY",763));
  si_do_deftype(3, VV[1], VVtemp[3], ECL_SYM("FIXNUM",372));
  (cl_env_copy->function=(ECL_SYM("MAPC",543)->symbol.gfdef))->cfun.entry(2, ECL_SYM("PROCLAIM",666), VVtemp[4]) /*  MAPC */;
  ...
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[3], ECL_SYM("LOCATION",1777), VVtemp[8], VVtemp[9]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[3], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[10]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[26]);                          /*  %%PARENTS       */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VVtemp[11], ECL_SYM("LOCATION",1777), VVtemp[12], VVtemp[13]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VVtemp[11], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[14]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[27]);                          /*  (SETF %%PARENTS) */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[5], ECL_SYM("LOCATION",1777), VVtemp[15], VVtemp[16]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[5], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[17]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[28]);                       /*  DO-%%PARENTS    */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[7], ECL_SYM("LOCATION",1777), VVtemp[18], VVtemp[19]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[7], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[20]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[29]);                          /*  %%PARENTS-ADD   */
  ...
  ecl_cmp_defmacro(VV[30]);                       /*  %%PUSH-PARENTS  */
  si_do_deftype(3, VV[9], VVtemp[24], ECL_SYM("SIMPLE-ARRAY",763));
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[10], ECL_SYM("LOCATION",1777), VVtemp[25], VVtemp[26]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[10], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[7]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[31]);                          /*  ORDER           */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[11], ECL_SYM("LOCATION",1777), VVtemp[27], VVtemp[28]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[11], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[7]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[32]);                          /*  SIZE            */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[12], ECL_SYM("LOCATION",1777), VVtemp[29], VVtemp[30]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[12], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[7]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[33]);                          /*  INDEGREES       */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[13], ECL_SYM("LOCATION",1777), VVtemp[31], VVtemp[32]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[13], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[33]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[34]);                       /*  DO-EDGES        */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[15], ECL_SYM("LOCATION",1777), VVtemp[34], VVtemp[35]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[15], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[36]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[35]);                       /*  DO-PARENTS      */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[17], ECL_SYM("LOCATION",1777), VVtemp[37], VVtemp[38]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[17], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[39]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[36]);                       /*  DO-PARENTS-GRANDPARENTS */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[19], ECL_SYM("LOCATION",1777), VVtemp[40], VVtemp[41]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[19], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[7]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[37]);                          /*  OUTDEGREES      */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[20], ECL_SYM("LOCATION",1777), VVtemp[42], VVtemp[43]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[20], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[44]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[38]);                          /*  ADD-EDGE        */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[21], ECL_SYM("LOCATION",1777), VVtemp[45], VVtemp[46]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[21], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[47]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[39]);                          /*  MAKE-GRAPH-FROM-ADJ */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[22], ECL_SYM("LOCATION",1777), VVtemp[48], VVtemp[49]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[22], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[50]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[40]);                          /*  MAP-NODES       */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[23], ECL_SYM("LOCATION",1777), VVtemp[51], VVtemp[52]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[23], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[53]) /*  ANNOTATE */;
  ecl_cmp_defmacro(VV[41]);                       /*  DO-NODES        */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[14], ECL_SYM("LOCATION",1777), VVtemp[54], VVtemp[55]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[14], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[50]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[42]);                          /*  MAP-EDGES       */
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[16], ECL_SYM("LOCATION",1777), VVtemp[56], VVtemp[57]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[16], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[50]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[43]);                          /*  MAP-PARENTS     */
  si_set_documentation(3, VV[16], ECL_SYM("FUNCTION",396), VVtemp[58]);
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[18], ECL_SYM("LOCATION",1777), VVtemp[59], VVtemp[60]) /*  ANNOTATE */;
  ecl_function_dispatch(cl_env_copy,ECL_SYM("ANNOTATE",1771))(4, VV[18], ECL_SYM("LAMBDA-LIST",998), ECL_NIL, VVtemp[50]) /*  ANNOTATE */;
  ecl_cmp_defun(VV[44]);                          /*  MAP-PARENTS-GRANDPARENTS */
  si_set_documentation(3, VV[18], ECL_SYM("FUNCTION",396), VVtemp[61]);
}
