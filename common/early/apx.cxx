...
/*      Source: /home/packer/ws/github/kisp/asgl/common/early/apx.lisp */
...
TTL:
  {
   ...
   ecl_function_dispatch(cl_env_copy,VV[8])(1, v1) /*  DM-TOO-FEW-ARGUMENTS */;
L3:;
   {
    cl_object v5;
    v5 = ECL_CONS_CAR(v3);
   ...
   if (Null(v4)) { goto L8; }
   ecl_function_dispatch(cl_env_copy,VV[9])(1, v1) /*  DM-TOO-MANY-ARGUMENTS */;
L8:;
   value0 = cl_listX(4, ECL_SYM("LET",479), VV[2], VV[3], v3);
   return value0;
  }
 }
}
...
L1:;
  {
   ...
   T1 = cl_namestring(T0);
   T2 = ecl_function_dispatch(cl_env_copy,VV[11])(4, T1, ECL_SYM("BASE-CHAR",122), ECL_SYM("*",20), ECL_NIL) /*  COERCE-TO-VECTOR */;
   {
    void* v5;
    long v6;
    {
...
v6= msize;
   ...
   }
   {
    ...
    }
    {
     ...
     v7 = cl_make_hash_table(2, ECL_SYM("TEST",1350), T0);
     ...
     {
      cl_object v10;
      v10 = ecl_make_cclosure_va((cl_objectfn)LC3__lambda63,env1,Cblock,2);
      T0 = v10;
     }
...
/*      closure LAMBDA63                                              */
/*      optimize speed 3, debug 0, space 0, safety 1                  */
static cl_object LC3__lambda63(cl_narg narg, cl_object v1from, cl_object v2to, ...)
{
 cl_object CLV0;
 const cl_env_ptr cl_env_copy = ecl_process_env();
 ...
 {
TTL:
  value0 = ecl_function_dispatch(cl_env_copy,VV[12])(3, ECL_CONS_CAR(CLV0), v1from, v2to) /*  ADD-EDGE */;
  return value0;
 }
 }
}
...
extern "C"
#endif
ECL_DLLEXPORT void _eclqMFRzztbaOQJM_7uDycC71(cl_object flag)
{
 const cl_env_ptr cl_env_copy = ecl_process_env();
 cl_object value0;
 cl_object *VVtemp;
 ...
 flag->cblock.source = ecl_make_constant_base_string("/home/packer/ws/github/kisp/asgl/common/early/apx.lisp",-1);
 return;}
 #ifdef ECL_DYNAMIC_VV
 VV = Cblock->cblock.data;
 #endif
 Cblock->cblock.data_text = (const cl_object *)"@EcLtAg:_eclqMFRzztbaOQJM_7uDycC71@";
 ...
 ECL_DEFINE_SETF_FUNCTIONS
  ...
  ecl_cmp_defun(VV[10]);                          /*  READ-APX-FILE   */
}
