...
#+BEGIN_SRC lisp :tangle yes
  (defmethod first-solution ((engine gecode-engine))
    (block nil
      (map-solutions
       engine
       (lambda (x)
...
#+BEGIN_SRC lisp :tangle yes
  (defmethod first-solution-exists-p ((engine gecode-engine))
...
#+BEGIN_SRC lisp :tangle yes
  (defmethod print-solutions ((engine gecode-engine) stream)
    (let (statistics)    
      (unwind-protect
           (progn
             (write-line "[" stream)
...
#+BEGIN_SRC lisp :tangle yes
  (defmethod print-first-solution ((engine gecode-engine) stream)
    (let ((space (gecode:dfs-next (gecode-engine engine))))
